...
ROOT_DIR = os.path.abspath(os.path.join(
    ...
    os.pardir))
_EXPECTED = '''\
{0}switchmap-ng{0}tests{0}switchmap_{0}poll{0}snmp{0}cisco'''.format(os.sep)
...
from switchmap.poll.snmp.cisco import mib_ciscovlaniftablerelationship as testimport
