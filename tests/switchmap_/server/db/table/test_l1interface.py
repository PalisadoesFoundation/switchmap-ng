...
def _convert(row):
    ...
    result = IL1Interface(
        ...
        ifin_nucast_pkts=getattr(row, "ifin_nucast_pkts", 0),
        ifin_octets=getattr(row, "ifin_octets", 0),
        ifout_discards=getattr(row, "ifout_discards", 0),
        ifout_errors=getattr(row, "ifout_errors", 0),
        ifout_octets=getattr(row, "ifout_octets", 0),
        ifout_nucast_pkts=getattr(row, "ifout_nucast_pkts", 0),
        ts_idle=row.ts_idle,
        cdpcachedeviceid=row.cdpcachedeviceid,
        cdpcachedeviceport=row.cdpcachedeviceport,
        cdpcacheplatform=row.cdpcacheplatform,
...
def _row():
    ...
    result = IL1Interface(
        ...
        ifin_octets=random.randint(0, 1000000),
        ifout_octets=random.randint(0, 1000000),
