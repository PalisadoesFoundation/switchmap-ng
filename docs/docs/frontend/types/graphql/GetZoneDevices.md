...
Defined in: [types/graphql/GetZoneDevices.ts:35](https://github.com/PalisadoesFoundation/switchmap-ng/blob/develop/frontend/src/app/types/graphql/GetZoneDevices.ts#L35)
