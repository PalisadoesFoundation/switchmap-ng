    ...
    def __init__(self, config, hostname, ifindices=None):
        ...
        for ifindex, metadata in yaml_data['layer1'].items():
            ...
            if _is_ethernet(metadata) is True:
                ...
                # Update vlan to universal switchmap.metadata value
                ...
                # Update duplex to universal switchmap.metadata value
...
def _duplex(metadata):
    ...
    if not duplex and 'c2900PortLinkbeatStatus' in metadata:
