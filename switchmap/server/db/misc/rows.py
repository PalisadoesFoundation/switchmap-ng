...
def l1interface(row):
    ...
    result = RL1Interface(
        ...
        ifout_errors=row.ifout_errors,
        ifout_discards=row.ifout_discards,
        ifin_nucast_pkts=row.ifin_nucast_pkts,
        ifout_nucast_pkts=row.ifout_nucast_pkts,
        ifin_octets=row.ifin_octets,
        ifout_octets=row.ifout_octets,
        enabled=int(bool(row.enabled) is True),
        ts_created=row.ts_created,
        ts_modified=row.ts_modified,
    )
