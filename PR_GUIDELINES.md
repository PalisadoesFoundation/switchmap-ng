...
In order to give everyone a chance to submit a pull request and contribute to the repository, we have put restrictions in place. This section outlines the guidelines that should be imposed upon pull requests in the repo.
...
1. Pull requests must be based on [open issues](https://github.com/PalisadoesFoundation/switchmap-ng/issues) available.
